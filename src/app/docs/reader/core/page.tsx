...
import { CodeBlock, DocTable, TipBox, WarnBox, H2, H3, H4, P, InlineCode, Strong, Highlight } from "../_components/doc-components"
...
export default function CoreDocPage() {
  return (
    <DocLayout
      ...
      breadcrumb="基础核心"
      title="easyfk-core 核心模块"
      subtitle="基础核心模块 — 全局工具与底层支撑"
      readingTime="~20 min"
    >
{/* ============== 1. 模块概述 ============== */}
...
Integer value = ExpressionUtil.parse("#order.amount", method, args, Integer.class);`}</CodeBlock>
              ...
              <P><InlineCode>IMAGE</InlineCode> / <InlineCode>FILE</InlineCode> / <InlineCode>VIDEO</InlineCode></P><div className="rounded-[10px] border border-[#1F2937] bg-white/[0.024] px-5 py-4 text-center">
