...
const sidebarSections: { title?: string; items: { label: string; active?: boolean; href?: string }[] }[] = [
  ...
  { title: "ORM 数据访问", items: [{ label: "Hibernate", href: "/docs/reader/orm-hibernate" },{ label: "MyBatis", href: "/docs/reader/orm-mybatis" },{ label: "MyBatis-Flex", active: true },{ label: "ShardingSphere", href: "/docs/reader/orm-sharding" }]},
    ...
    <div className="relative isolate h-screen overflow-hidden bg-[#0B0C0E] text-white">
      ...
      <header className="sticky top-0 z-50 flex h-14 items-center justify-between border-b border-[#1F2937] bg-[#0B0C0E] px-6">
        ...
        <div className="flex items-center gap-2 text-[13px] text-[#525252]">
          ...
          <span>后端</span>
          <span>/</span>
          <span className="font-medium text-[#9CA3AF]">MyBatis-Flex</span>
        </div>
        <button
          type="button"
          ...
          <div className="mx-auto max-w-[800px] px-[60px] py-10">
            <div className="flex flex-col gap-8">
              ...
              <h1 className="font-display text-[36px] font-bold tracking-[-1px] text-white">
                easyfk-orm-flex MyBatis-Flex
              </h1>
              <div className="flex items-center gap-4 text-[12px] text-[#525252]">
                <span>MyBatis-Flex — 优雅的 MyBatis 增强框架</span>
...
└── util
    ...
    └── RangeConditionUtil.java            # 区间条件构建`}</CodeBlock>
              ...
              <div className="flex gap-4">
                <Link href="/docs/reader/orm-mybatis" className="flex flex-1 flex-col gap-1 rounded-[10px] border border-[#1F2937] bg-white/[0.024] p-5 transition-colors hover:border-[#374151]">
                ...
                <Link href="/docs/reader/orm-sharding" className="flex flex-1 flex-col items-end gap-1 rounded-[10px] border border-[#1F2937] bg-white/[0.024] p-5 transition-colors hover:border-[#374151]">
                  <div className="flex items-center gap-1.5 text-[12px] text-[#525252]">
                    <span>下一篇</span>
