...
└── util
    └── MongoConditionBuilder.java        # 查询条件构建器（SearchCondition → Query）`}</CodeBlock>
              ...
              <P>9. <Strong>事务支持</Strong>：MongoDB 4.0+ 副本集环境下，可使用 Spring <InlineCode>@Transactional</InlineCode> 实现多文档事务。</P><div className="rounded-[10px] border border-[#1F2937] bg-white/[0.024] px-5 py-4 text-center">
